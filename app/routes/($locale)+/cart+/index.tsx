 ...
 * @param storefront strorefront instance
 ...
 * @param lines [CartLineUpdateInput!]! https://shopify.dev/api/storefront/2022-07/input-objects/cartlineupdateinput
 * @param cartId the current cart id
 * @param storefront strorefront instance
 * @see https://shopify.dev/api/storefront/2022-07/mutations/cartlinesremove
 * @returns mutated cart
 ...
 * @param storefront strorefront instance strorefront instance
