 ...
 * 1. If a cart exists it's updated with the discount,
 * 2. otherwise a cart is created with the discount already applied
...
export default function DiscountCodeApiRoute() {
  return null;
}
